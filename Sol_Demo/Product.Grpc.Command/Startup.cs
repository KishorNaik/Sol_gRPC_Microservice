...
using Product.Grpc.Command.Services;
using System;
...
namespace Product.Grpc.Command
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapGrpcService<CreateProductService>();
                endpoints.MapGrpcService<UpdateProductService>();
                endpoints.MapGrpcService<RemoveProductService>();
